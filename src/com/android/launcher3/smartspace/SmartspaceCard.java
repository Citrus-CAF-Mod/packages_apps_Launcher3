...
import com.android.launcher3.smartspace.nano.SmartspaceProto.b;
import com.android.launcher3.smartspace.nano.SmartspaceProto.c;
import com.android.launcher3.smartspace.nano.SmartspaceProto.e;
import com.android.launcher3.smartspace.nano.SmartspaceProto.i;
import com.android.launcher3.utils.ColorManipulation;
...
public class SmartspaceCard {
    ...
    private com.android.launcher3.smartspace.nano.SmartspaceProto.d cG(final boolean b) {
        final c ch = this.cH();
        if (ch != null) {
            com.android.launcher3.smartspace.nano.SmartspaceProto.d d;
            if (b) {
                d = ch.cL;
            } else {
                d = ch.cM;
    ...
    private boolean cL(final com.android.launcher3.smartspace.nano.SmartspaceProto.d d) {
        boolean b = false;
    ...
    private String cO(final boolean b, final String s) {
        final com.android.launcher3.smartspace.nano.SmartspaceProto.d cg = this.cG(b);
