...
public class SmartspaceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        byte[] byteArrayExtra = intent.getByteArrayExtra("com.android.launcher3.extra.SMARTSPACE_CARD");
        if (byteArrayExtra != null) {
            com.android.launcher3.smartspace.nano.SmartspaceProto.a a = new com.android.launcher3.smartspace.nano.SmartspaceProto.a();
            try {
