...
import com.android.launcher3.search.ItemInfoUpdateReceiver;
import com.android.launcher3.smartspace.SmartspaceView;
...
public class CustomLauncher {
    ...
    com.android.launcher3.custom.CustomLauncherOverlay fz;
    private boolean mStarted;
    private final Bundle mUiInformation = new Bundle();
    private ItemInfoUpdateReceiver mItemInfoUpdateReceiver;

    public CustomLauncher(CustomLauncherActivity activity) {
        fB = activity;
        fD = activity;
        fA = new CustomLauncherCallbacks();
    ...
    private static GoogleNow.IntegerReference dZ(SharedPreferences sharedPreferences) {
        return new GoogleNow.IntegerReference(
                (sharedPreferences.getBoolean(CustomSettingsActivity.ENABLE_MINUS_ONE_PREF, true) ? 1 : 0) | 0x2 | 0x4 | 0x8);
    }

    class CustomLauncherCallbacks implements LauncherCallbacks, SharedPreferences.OnSharedPreferenceChangeListener, WallpaperColorInfo.OnChangeListener {
        ...
        public void onCreate(final Bundle bundle) {
            ...
            fz = new com.android.launcher3.custom.CustomLauncherOverlay(fB);
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if (CustomSettingsActivity.ENABLE_MINUS_ONE_PREF.equals(key)) {
