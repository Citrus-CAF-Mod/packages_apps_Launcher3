...
import com.android.launcher3.search.nano.SearchProto.a_search;
import com.android.launcher3.search.nano.SearchProto.b_search;
import com.android.launcher3.search.nano.SearchProto.c_search;
import com.android.launcher3.search.nano.SearchProto.d_search;
...
public class ConfigBuilder {
    ...
    private final CustomLauncherActivity mActivity;
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        Intent intent = new Intent("com.android.launcher3.FAST_TEXT_SEARCH");
    ...
    private b_search bZ(final AppInfo appInfo, final int n) {
        ...
        b.el = dm.toString();
        b.ek = new Intent("com.android.launcher3.search.APP_LAUNCH", dm.buildUpon().appendQueryParameter("predictionRank", Integer.toString(n)).build()).toUri(0);
        return b;
    }
