...
public class LongClickReceiver extends BroadcastReceiver {
    private static WeakReference<SettingsActivity> bR = new WeakReference<>(null);

    public static void bq(final SettingsActivity settingsActivity) {
        LongClickReceiver.bR = new WeakReference<>(settingsActivity);
    }

    public void onReceive(final Context context, final Intent intent) {
        final SettingsActivity launcher = LongClickReceiver.bR.get();
        if (launcher != null) {
